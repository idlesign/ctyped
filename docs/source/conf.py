# -*- coding: utf-8 -*-
#
# ctyped documentation build configuration file.
#
...
latex_documents = [
  ('index', 'ctyped.tex', u'ctyped Documentation',
...
man_pages = [
    ('index', 'ctyped', u'ctyped Documentation',
